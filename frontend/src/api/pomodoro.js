...
export const optimizeAiPlan = (payload) => apiPost('/api/ai/plan-optimize', payload, { timeout: 90000 })
export const generateAiPlan = (payload) => apiPost('/api/ai/plan-generate', payload, { timeout: 90000 })
